...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado Personal  <a href="personal/create"><button class="btn btn-success">Nuevo</button></a></h3>
		@include('salidas.personal.search')
	</div>
</div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				@include('salidas.personal.modal')
				@endforeach
			</table>
		</div>
		{{$personas->render()}}
