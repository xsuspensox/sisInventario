    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Sis.Inv.</b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('salidas/salida')}}"><i class="fa fa-circle-o"></i> Salida</a></li>
                <li><a href="{{url('salidas/personal')}}"><i class="fa fa-circle-o"></i> Personal</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="{{url('seguridad/usuario')}}">
                ...
                <span>Usuarios</span>
                <small class="label pull-right bg-red">US</small>
              </a>
            </li>
